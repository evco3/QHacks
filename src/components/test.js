...
function Test() {
  ...
  const handleSubmit = async () => {
    ...
    const summarizeText = async (text) => {
        ...
        + calc+ ` calculation question(s). It should be based on of the following information/word/topic:\n\n${text}`+ ` Make sure you list the answers after in the format: ANSWER KEY: 1. A 2. B 3. C 4. B......, after the list of questions. ANSWER KEY must be in all caps`;
        console.log(prompt);
      try {
    ...
    <div id="mock-up-tests" className="notes-container">
      ...
      <div className="notes-content">
        ...
        <div>
          ...
          <button onClick={handleSubmit} disabled={isSubmitting} style={{width: 150, height: 30, margin:"0 auto"}}>
